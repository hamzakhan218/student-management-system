...
function Login() {
  ...
  return (
    <div className='bg-gray-200 h-screen flex justify-center items-center'>
      <div className='bg-white h-[500px] w-3/4 shadow-black shadow-2xl rounded-3xl rounded-tr-3xl'>
        ...
        <div>
            <form onSubmit={handleSubmit(onSubmit)} className='h-[320px] rounded-b-3xl items-center flex justify-center'>
                <div>
                    ...
                    <div className='flex justify-center'>
                        <input type='password' placeholder='Confirm password:' {...register("confirm_password", { required: true })} className='bg-gray-200 rounded-lg p-3 m-3 w-auto sm:w-[250px] md:w-[350px] lg:w-[500px] xl:w-[620px]'/>
                    </div>
                    <div className='flex justify-center'>
                        <button type='submit' className='w-[100px] bg-yellow-400 rounded-lg py-2'>Signup</button>
                    </div>
                    <div className='flex justify-center'>
                        <a href='/login' className='text-blue-500 underline pt-3 cursor-pointer'>Already have an account?</a>
                    </div>
                </div>
            </form>
        </div>
